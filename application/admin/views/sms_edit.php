            	...
            	<div class="navbar">
	                <div class="navbar-inner">
			            <ul class="breadcrumb">
				            ...
				            <li class="active">
				           	 	<a href="<?php echo site_url("sms/index")?>">短信接口列表</a> <span class="divider">/</span><a href="#">编辑短信接口</a>	
				            </li>
			            </ul>
	                </div>
		      	</div>
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">编辑短信接口</div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">
		                            ...
		                            <div class="alert alert-error hide">
                                     ...
                                     <form class="form-horizontal" action="<?php echo site_url("sms/edit")?>" id="sms_form" method="post">
                                      <fieldset>
                                        <div class="control-group">
                                          <label class="control-label" for="focusedInput">接口名称</label>
                                          <div class="controls">
                                            <input class="input-xlarge focused" id="name" name="name" type="text" palceholder="接口名称" value="<?php echo $sms['name'];?>">
                                          </div>
                                        </div>
                                        <div class="control-group">
                                          <label class="control-label" for="focusedInput">接口类名</label>
                                          <div class="controls">
                                            <input class="input-xlarge focused" id="class_name" name="class_name" type="text" palceholder="接口类名" value="<?php echo $sms['class_name'];?>">
                                          </div>
                                        </div>
                                        <div class="control-group">
                                          <label class="control-label" for="focusedInput">接口描述</label>
                                          <div class="controls">
                                            <textarea class="input-xlarge textarea" id="description" name="description" palceholder="接口描述" ><?php echo $sms['description'];?></textarea>
                                          </div>
                                        </div>
                                        <div class="form-actions">
                                          <input type="hidden" name="id" value="<?php echo $sms['id']?>"/>
                                          <button type="button" class="btn btn-primary save">保存</button>
                                          <a href="<?php echo site_url("sms/index")?>"><button type="button" class="btn">取消</button></a>
                                        </div>
                                      </fieldset>
                                    </form>
	...
	<script src="<?=base_url().'js/scripts.js'?>"></script>
        <script>
			$(".save").on('click', function(){
				$.ajax({
					url:"<?php echo site_url("sms/edit")?>",
					type:'post',
					dataType: 'json',
