...
! function ($) {
    ...
    BootstrapTable.LOCALES['en-US'] = BootstrapTable.LOCALES['zh-cn'] = {
        formatLoadingMessage: function () {
            return '正在努力地加载数据中，请稍候……';
        },
        formatRecordsPerPage: function (pageNumber) {
            return sprintf('每页展示%s条记录。', pageNumber);
        },
        formatShowingRows: function (pageFrom, pageTo, totalRows) {
            return sprintf('本页显示 %s到 %s条记录  ， 总共 %s行记录。      ', pageFrom, pageTo, totalRows);
        },
